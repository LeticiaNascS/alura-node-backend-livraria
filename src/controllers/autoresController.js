  ...
  static listarAutorPorId = async (req, res, next) => {
    ...
    static atualizarAutor = async (req, res, next) => {
      try {
        ...
        const autorResultado = await autores.findByIdAndUpdate(id, {$set: req.body}); // await para esperar a resposta do banco de dados, findByIdAndUpdate para encontrar o autor pelo id e atualizar os dados, $set para definir os novos dados do autor
         if(autorResultado !== null){
